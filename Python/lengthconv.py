...
def tg():
    ...
    if cm.get()==cm['values'][0]:
        if sc1.get()!="" and sc2.get()=="":
            a=str(int(sc1.get())*100)
            sc2.set(a)
        elif sc1.get()=="" and sc2.get()!="":
            a=str(int(sc2.get())/100)
            sc1.set(a)

    elif cm.get()==cm['values'][1]:
        if sc1.get() != "" and sc2.get() == "":
            a=str(int(sc1.get())*(10**(-9)))
            sc2.set(a)
        elif sc1.get() == "" and sc2.get() != "":
            a = str(int(sc2.get())*(10 **(9)))
            sc1.set(a)

    elif cm.get() == cm['values'][2]:
        if sc1.get() != "" and sc2.get() == "":
            a=str(int(sc1.get())*(10**(-10)))
            sc2.set(a)
        elif sc1.get() == "" and sc2.get() != "":
            a = str(int(sc2.get())*(10 **(10)))
            sc1.set(a)
...
cm['values']=("(1)meter <-> (2)centimeter", "(1)Nanometer <-> (2)meter", "(1)angstrom <-> (2)meter", "select any one")
cm.current(3)
cm.place(x=200, y=30)
